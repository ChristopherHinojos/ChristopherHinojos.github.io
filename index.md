...
* Lab 5 part 2
    ...
    For lab 5 part 2, it seems like a difficult one, but once the rhythm for making different integers and doubles started, it became easy. There were a lot of little things needed to just make some conversions, and how each number needed to be converted into different formats, like ints to double, and learned some new, different numbers like the max and min integer amounts. Definitely some interesting parts to limit the inputs from the terminal. 
